...
import one from './images/cyv3.jpg';
import two from './images/ed3.jpg';
import three from './images/wash2.jpg';
    ...
    return (
      ...
      >
        ...
        <div className={!slideMode ? classes.container : ''}>
          <Typography component="h2" variant="h2" gutterBottom>CHRISTIAN YOUTH VOLUNTEERS TRUST</Typography>
          <Typography component="p" variant="h5" gutterBottom>WELCOME TO CHRISTIAN YOUTH VOLUNTEERS TRUST</Typography>
