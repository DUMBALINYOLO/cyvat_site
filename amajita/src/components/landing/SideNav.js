...
class SideNav extends React.Component {
  state = {
    ...
    menuList: [
      ...
      createData(2, 'OUR PORTFOLIO', '#showcase'),
      createData(3, 'OUR TEAM', '#testimonials'),
      createData(4, 'OUR MISSION', '#tech'),
      createData(5, 'OUR BELIEFS', '#pricing'),
