...
class Company extends React.Component {
  ...
  render() {
    ...
    return (
      <PapperBlock title="About Cristian Yout Vounteers Trust" icon="ios-help-circle-outline" whiteBg desc="Sed imperdiet enim ligula, vitae viverra justo porta vel.">
