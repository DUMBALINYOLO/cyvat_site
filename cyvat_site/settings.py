"""
Django settings for cyvat_site project.
...
SECRET_KEY = '%egh5w3vsqkq@6=43orhgx-+mvrulwgiwk74zml)vdl=v-67g@'
...
WSGI_APPLICATION = 'cyvat_site.wsgi.application'
