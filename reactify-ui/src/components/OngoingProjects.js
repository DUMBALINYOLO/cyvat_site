...
import { ongoingProjectsURL } from '../constants';
...
const OngoingProjects = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const res = await axios.get(ongoingProjectsURL);
    ...
    const visitPage = (page) => {
        axios.get(`ongoingProjectsURL?page=${page}`)
        .then(res => {
            setProjects(res.data.results);
            setPrevious(res.data.previous);
            setNext(res.data.next);
